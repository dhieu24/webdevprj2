...
export default class page extends Component {
    ...
    dialogCallback = (data) => {
        if (data.action === `submit`) {
            ...
            this.editRow(data)
            toastr.success(`Task has been successfully editted!`, ``, { 'closeButton': true, positionClass: 'toast-bottom-right' });
            this.setState({ open: false });
        }
    }
                                            ...
                                            <TableCell align="center">
                                                ...
                                                <Button variant="contained" 
                                                    onClick={() => {this.setState((prevState) => ({
                                                        ...
                                                        toastr.success(`Task has been successfully deleted!`, ``, { 'closeButton': true, positionClass: 'toast-bottom-right' });
                                                    }}
                                                    color='error' 
